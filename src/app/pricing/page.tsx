  ...
  const faqs = [
    {
      ...
      answer: "The Basic plan is free and includes essential contract analysis features. You can analyze up to 2 contract analysis, identify 5 potential risks and opportunities, and get a brief contract summary. It's perfect for individuals just getting started with contract analysis."
    },
    {
